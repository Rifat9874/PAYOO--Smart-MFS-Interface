...
const payBillNumber = getValueFromInput("pay-money-number");
...
const cashoutPin = getValueFromInput("pay-money-pin");
if(cashoutPin === "1234"){
    alert("Your Bill has been Paid. Your new balance is: " + newBalance);
...
//  /1- get history container 
  ...
  //2 new div create
    ...
    <div class="transaction-card p-5 bg-base-100">
        Bill Paid Successfully ${cashoutAmount} BDT from ${cashoutNumber} 
